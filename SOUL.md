...
### Repo Anchor (Repo Specific)

- Current repo: `poddashboard`.
- Product shape: Bun API + React Router SPA for pod and event management.
- Data + auth baseline in this repo: Postgres + Drizzle + Auth.js credentials.
